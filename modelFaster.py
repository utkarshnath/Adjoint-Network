...
def conv(ni, no, ks, s=1, bias=False, expansion=4, compression_factor=4, masking_factor=None):
    ...
    return conv2dFaster(ni, no, kernel_size=ks, stride=s, padding=ks//2, bias=bias,mask_layer=mask_layer,compression_factor=compression_factor,masking_factor=masking_factor)
