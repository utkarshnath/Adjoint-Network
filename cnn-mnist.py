...
def get_cnn_model(data):
    return nn.Sequential(
        Lambda(mnist_resize),
        nn.Conv2d( 1, 8, 5, padding=2,stride=1), nn.ReLU(), #14
        nn.Conv2d( 8,16, 3, padding=1,stride=1), nn.ReLU(), # 7
        nn.Conv2d(16,32, 3, padding=1,stride=1), nn.ReLU(), # 4
        nn.Conv2d(32,32, 3, padding=1,stride=1), nn.ReLU(), # 2
